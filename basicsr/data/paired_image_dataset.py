...
class PairedImageDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print('[DEBUG] self.opt:{}'.format(self.opt['phase']))
        ...
        if self.opt['phase'] == 'train':
            ...
            # padding
            img_gt, img_lq = padding(img_gt, img_lq, gt_size) # no padding if img_gt > gt_size
        ...
        if self.opt['phase'] == 'val':
            if self.opt['crop_val']:
                gt_size = self.opt['gt_size']
                # print('val gt size:{}'.format(gt_size))
                img_gt, img_lq = paired_random_crop(img_gt, img_lq, gt_size, scale,
                                                    gt_path)
                # print('val:lq.shape:{}'.format(img_lq.shape))
